...
作为一个统计系的学生，有非常大的概率在DS面试中会被问到统计问题，包括probability，inference，linear regression等等。有些公司highly evaluate这个部分，我自己面过的公司中，比较突出这个部分，专门用半个小时来考查这部分的有Disney，Upstart， indeed.com。
